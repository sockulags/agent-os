...
| CW-P8S Blind continuation | A fresh `shape-work` session receives only the completed open handoff and evidence reachable from it. | The session preserves settled decisions and asks only the recorded remaining questions, without hidden conversation context or re-litigating rejected alternatives. |
