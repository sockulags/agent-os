...
| IA-P2 | Invoke `init-agent-os` in a repository with existing instructions. | It reads repository facts, asks only for missing material defaults, writes the smallest useful policy, and shows the diff. |
