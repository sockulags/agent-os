...
the agent is about to write prose a person will read.
...
| PV-P3 Ordinary reply | "Förklara varför testerna blev långsammare efter förra veckans ändring." | Trigger `plain-voice`. A chat reply is prose for a human reader. |
