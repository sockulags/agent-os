...
The receipt is complete only when every finding maps to fixed, rejected, deferred, decision-needed or
unresolved. Fresh completion evidence belongs to the verification step, not to this receipt.
